...
class StoreVehicleRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'hourly_fuel_consumption'           => 'required|between:0,99.99',
    ...
    public function messages()
    {
        return [
            ...
            'hourly_fuel_consumption.required'              => 'Hourly Fuel Consumption is Required',
            'hourly_fuel_consumption.between'               => 'Provide Valid Hourly Fuel Consumption',
