    ...
    <div class="section">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Temperature Report of {{ $vehicleInfo->vehicle_plate_number }}</li>
            </ol>
        </div>
...
<script>
    $(document).ready(function() {
        ...
        function fetch_data(page) {
            ...
            $.ajax({
                url: "{{ route('vehicle-temp-data-paginate') }}",
                method: 'POST',
                data: {
                    page: page,
        ...
        $('#btnShowData').on('click', function() {
            selectedDate = $("#dataDate").val();
            $.ajax({
                url: "{{ route('vehicle-temp-dated-data') }}",
                method: 'POST',
                data: {
                    vehicleId: "{{ $vehicleInfo->vehicle_id }}",
                    selectedDate: selectedDate,
        ...
        $('#excelExport').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('vehicle-temp-export-as-excel') }}",
                method: 'POST',
                data: {
                    startDate: startDate,
                    endDate: endDate,
        ...
        function JSONToCSVConvertor(info, JSONData, ReportTitle, ShowLabel) {
            ...
            CSV += ReportTitle + ' of \r\n';
            CSV += 'Vehicle Regi No: ' + info.vehicleNumber + '\r\n';
