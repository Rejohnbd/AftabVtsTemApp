    ...
    <div class="section">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Maintenance Type List</li>
            </ol>
            <div class="ml-auto">
                <a href="{{ route('maintenance-type.create') }}" class="btn btn-primary btn-icon btn-sm text-white mr-2">
                    <span>
                        <i class="fe fe-plus"></i>
                    </span> Add Maintenance Type
                </a>
            </div>
        </div>
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Maintenance Type Table</h3>
                    </div>
                        ...
                        <table class="table card-table table-vcenter text-nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>Maintenance Type Status</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse($datas as $data)
                                <tr id="maintenanceTypeId-{{ $data->maintenance_type_id }}">
                                    <th scope="row">{{ $loop->iteration }}</th>
                                    <td>{{ $data->maintenance_type_name }}</td>
                                ...
                                @empty
                                <tr>
                                    <th colspan="4" class="text-center">No Maintenance Type Added Now.</th>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
