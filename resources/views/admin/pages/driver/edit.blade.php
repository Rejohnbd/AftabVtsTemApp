    ...
    <div class="section">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Edit Driver</li>
            </ol>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('driver_first_name') is-invalid @enderror" name="driver_first_name" placeholder="Driver First Name" value="{{ old('driver_first_name', $driver->driver_first_name) }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('driver_last_name') is-invalid @enderror" name="driver_last_name" placeholder="Driver Last Name" value="{{ old('driver_last_name', $driver->driver_last_name) }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control @error('driver_email') is-invalid @enderror" name="driver_email" placeholder="Driver Email" value="{{ old('driver_email', $driver->user->email) }}" required>
                                        @error('driver_email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control @error('driver_password') is-invalid @enderror" name="driver_password" placeholder="Driving Password" value="{{ old('driver_password') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('driver_mobile') is-invalid @enderror" name="driver_mobile" placeholder="Driver Mobile" value="{{ old('driver_mobile', $driver->driver_mobile) }}" required>
                                        @error('driver_mobile')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group mt-2">
                                        <div class="form-group">
                                            ...
                                            <select name="driver_gender" class="form-control @error('driver_gender') is-invalid @enderror select2 custom-select" data-placeholder="Choose one" required>
                                                ...
                                                <option value="other" @if($driver->driver_gender == 'other') selected @endif>Other</option>
                                            </select>
                                            @error('driver_gender')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control @error('status') is-invalid @enderror select2 custom-select" data-placeholder="Choose one" required>
                                            ...
                                            <option value="0" @if($driver->status == 0) selected @endif>Inactive</option>
                                        </select>
                                        @error('status')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-success btn-block">Update Driver</button>
                                </div>
                                <div class="col-md-6">
