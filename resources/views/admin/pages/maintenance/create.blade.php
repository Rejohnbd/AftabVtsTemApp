    ...
    <div class="section">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Create Maintenance</li>
            </ol>
        </div>
        <div class="row">
            <div class="col-md">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('maintenance.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mt-2">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control  @error('maintenance_details') is-invalid @enderror" name="maintenance_details" rows="4" placeholder="Maintenance Details" required>{{ old('maintenance_details') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            </div><input class="form-control fc-datepicker" name="maintenance_date" value="{{ old('maintenance_date') }}" placeholder="MM/DD/YYYY" type="text" required>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            </div><input class="form-control fc-datepicker" name="maintenance_next_date" value="{{ old('maintenance_next_date') }}" placeholder="MM/DD/YYYY" type="text" required>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-success btn-block">Save Maintenance</button>
                                </div>
                                <div class="col-md-6">
