                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('vehicle_fuel_tank_capacity') is-invalid @enderror" name="vehicle_fuel_tank_capacity" placeholder="Vehicle Fuel Tank Capacity" value="{{ old('vehicle_fuel_tank_capacity') }}" >
