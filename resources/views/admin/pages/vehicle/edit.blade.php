                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('hourly_fuel_consumption') is-invalid @enderror" name="hourly_fuel_consumption" placeholder="Hourly Fuel Consumption" value="{{ old('hourly_fuel_consumption', $vehicle->hourly_fuel_consumption) }}" required>
