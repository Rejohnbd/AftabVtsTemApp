    ...
    <div class="section">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Edit Trips</li>
            </ol>
        </div>
            ...
            <div class="col-md">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Trips</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="trip_type_id" class="form-control @error('trip_type_id') is-invalid @enderror select2 custom-select" data-placeholder="Choose one" required>
                                            ...
                                            <option value="{{ $tripType->trip_type_id}}" @if($trip->trip_type_id == $tripType->trip_type_id) selected @endif>{{ $tripType->trip_type_name}}</option>
                                            @endforeach
                                        </select>
                                        @error('trip_type_id')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="vehicle_id" class="form-control @error('vehicle_id') is-invalid @enderror select2 custom-select" data-placeholder="Choose one" required>
                                            ...
                                            <option value="{{ $freeVehicle->vehicle_id }}" @if($trip->vehicle_id == $freeVehicle->vehicle_id) selected @endif>{{ $freeVehicle->vehicle_plate_number }}</option>
                                            @endforeach
                                        </select>
                                        @error('vehicle_id')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="driver_user_id" class="form-control @error('driver_user_id') is-invalid @enderror select2 custom-select" data-placeholder="Choose one" required>
                                            ...
                                            <option value="{{ $freeDriver->driver_user_id }}" @if($trip->driver_user_id == $freeDriver->driver_user_id) selected @endif>{{ $freeDriver->driver_first_name }} {{ $freeDriver->driver_last_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('trip_from') is-invalid @enderror" name="trip_from" placeholder="Trip From" value="{{ old('trip_from', $trip->trip_from) }}" required>
                                        @error('trip_from')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('trip_to') is-invalid @enderror" name="trip_to" placeholder="Trips To" value="{{ old('trip_to', $trip->trip_to) }}" required>
                                        @error('trip_to')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mt-2">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control  @error('trip_details') is-invalid @enderror" name="trip_details" rows="4" placeholder="Trips Details" required>{{ old('trip_details', $trip->trip_details) }}</textarea>
                                            @error('trip_details')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            </div><input class="form-control fc-datepicker" name="trip_date" value="{{ old('trip_date', $trip->trip_date) }}" placeholder="MM/DD/YYYY" type="text" required>
                                        </div>
                                        @error('trip_date')
                                        <span class="invalid-feedback" style="display: block !important;" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-success btn-block">Update Trip</button>
                                </div>
                                <div class="col-md-6">
