...
@section('title', 'Vehicle Device Assign')
    ...
    <div class="section">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Vehicle Device Assign</li>
            </ol>
        </div>
        ...
        <div class="row">
            <div class="col-md">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('vehicle-device-store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="hidden" name="vehicle_id" value="{{ $vechileId }}">
