...
@section('title', 'Create Device Types')
    ...
    <div class="section">
        <div class="page-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Create Device Type</li>
            </ol>
        </div>
        ...
        <div class="row">
            <div class="col-md">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('device-type.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="form-label">Device Type Name</label>
                                        <input type="text" class="form-control @error('device_type_name') is-invalid @enderror" name="device_type_name" placeholder="Device Type" value="{{ old('device_type_name') }}" required>
